...
def main():
    ...
    def make_env(process_idx, test):
        ...
        env1 = env.create_environment(env_name='academy_empty_goal_close', render=False,representation='simple115')


        return env1


    env1 = env.create_environment(env_name ='academy_3_vs_1_with_keeper',render=True,representation='simple115')
